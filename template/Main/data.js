export const data = {
  home: {
    ...
    title: [
      'Somos a sua aceleradora de processos contábeis e financeiros!',
      'We are your accelerator for accounting and financial processes!'
    ],
    content: [
      'Ganhe qualidade e eficiência em sua operação automatizando desde a sua emissão de notas até gerenciamento contábil e financeiro.',
      'Gain quality and efficiency in your operation by automating everything from issuing bills to accounting and financial management.',
    ],  
  },
  about: {
    title: [
    ...
    operation: [
      {
        ...
        title: [
          'Faça integrações completas e automatizadas das funcionalidades via API ou Upload de arquivos', 
          'Make complete and automated integrations of functionality via API or File Upload'
        ],
      },
      {
        image: {
        ...
        title: [
          'Tenha eficiência operacional, gestão efetiva e controle gerencial de de seus resultados', 
          'Have operational efficiency, effective management and managerial control of your results'
        ]
      },
      {
        image: {
      ...
      },
      {
        ...
        title: [
          'Tenha acesso remoto à suas operações, veja a prévia de seus resultados e muito mais funcionalidades', 
          'Get remote access to your operations, preview your results and much more'
        ]
      }
    ],
    institutional: {
      video: {
        src: '/videos/setfin-2021.mp4',
        alt: 'SetFin Video',
        height: 300,
        width: 300,
      },
